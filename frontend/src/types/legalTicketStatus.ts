...
export const LEGAL_TICKET_STATUS_LABEL_KEYS: Record<LegalTicketStatus, string> = {
  ...
  PENDING_EXPERT_ASSESSMENT: "legalTickets.filters.PENDING_ADMIN_REVIEW",
  RECLASSIFICATION_REQUESTED: "legalTickets.filters.PENDING_ADMIN_REVIEW",
  WAITING_USER_ACCEPTANCE: "legalTickets.filters.NEED_MORE_INFO",
  WAITING_PAYMENT: "legalTickets.filters.NEED_MORE_INFO",
  READY_FOR_ASSIGNMENT: "legalTickets.filters.PENDING_ADMIN_REVIEW",
  PENDING_EXPERT_ACCEPTANCE: "legalTickets.filters.ASSIGNED_TO_LAWYER",
  ASSIGNED_TO_EXPERT: "legalTickets.filters.ASSIGNED_TO_LAWYER",
  ...
  INACTIVE_WARNING: "legalTickets.filters.IN_REVIEW",
  OVERDUE: "legalTickets.filters.IN_REVIEW",
  SLA_BREACHED: "legalTickets.filters.IN_REVIEW",
  ADMIN_INTERVENTION: "legalTickets.filters.IN_REVIEW",
  PENDING_REASSIGNMENT: "legalTickets.filters.PENDING_ADMIN_REVIEW",
  PARTIALLY_COMPLETED: "legalTickets.filters.IN_REVIEW",
  RESOLVED: "legalTickets.filters.RESOLVED",
  CLOSED: "legalTickets.filters.CLOSED",
  CANCELLED: "legalTickets.filters.CANCELLED",
  CANCELLED_BY_USER: "legalTickets.filters.CANCELLED",
  REOPENED: "legalTickets.filters.REOPENED",
  FAILED_BY_EXPERT: "legalTickets.filters.CANCELLED",
  FAILED_BY_USER: "legalTickets.filters.CANCELLED",
  REFUND_PENDING: "legalTickets.filters.NEED_MORE_INFO",
  REFUNDED: "legalTickets.filters.CLOSED",
};
