...
public class RevenuePeriod extends BaseEntity {
    ...
    @PrePersist void create(){ if(id==null) id="revperiod_"+UUID.randomUUID().toString().replace("-",""); if(status==null) status=RevenuePeriodStatus.OPEN; }
}
