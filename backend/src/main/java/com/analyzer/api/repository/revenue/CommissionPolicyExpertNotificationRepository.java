...
import com.analyzer.api.entity.CommissionPolicyExpertNotification;
...
@Repository
public interface CommissionPolicyExpertNotificationRepository
        extends JpaRepository<CommissionPolicyExpertNotification, Long> {
