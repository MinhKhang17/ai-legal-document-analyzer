...
public interface LegalTicketMapper {
    ...
    @Mapping(target = "senderRole", expression = "java(message.getSender() != null && message.getSender().getRole() != null && message.getSender().getRole().getName() != null ? message.getSender().getRole().getName().name() : null)")
